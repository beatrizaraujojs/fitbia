<header class="header">
    <div class="container header-container">
        ...
        <div class="header-icones">
            ...
            <a href="{{ route('site.checkout') }}" aria-label="Carrinho" style="position: relative;">
                <i class="ph ph-shopping-cart"></i>
                <span id="contador-carrinho" style="display: none; position: absolute; top: -5px; right: -10px; background: red; color: white; border-radius: 50%; padding: 2px 6px; font-size: 10px; font-weight: bold;">0</span>
            </a>
