...
<form action="{{ route('pedido.salvar') }}" method="POST">
  ...
  <div class="checkout-layout">
      ...
      <div class="checkout-secao etapa-checkout ativo" id="conteudo-etapa-1">
        ...
        <div class="form-grid">
          ...
          <div class="input-group">
            ...
            <input type="text" id="endereco_sp" name="endereco" placeholder="Rua, Avenida, Alameda..." required />
          </div>
          <div class="input-group">
            <label for="numero_casa">Número</label>
            {{-- Adicionado name="numero" --}}
            <input type="text" id="numero_casa" name="numero" placeholder="Número da casa ou prédio" required />
          </div>
          <div class="input-group">
            <label for="bairro_cond">Bairro / Condomínio</label>
            {{-- Adicionado name="bairro" --}}
            <input type="text" id="bairro_cond" name="bairro" placeholder="Seu bairro ou condomínio" required />
          </div>
          <div class="input-group">
            <label for="apto_ref">APTO / Referência / Complemento</label>
            {{-- Adicionado name="complemento" --}}
            <input type="text" id="apto_ref" name="complemento" placeholder="Apto, bloco, ponto de referência..." />
          </div>
        </div>
        <div class="botoes-etapa">
          {{-- type="button" para não enviar o form antes da hora --}}
      ...
      <div class="checkout-secao etapa-checkout" id="conteudo-etapa-3">
        ...
        <div class="form-grid">
          <div class="input-group">
            ...
            <input type="text" id="nome_titular" name="nome_cliente" placeholder="Seu nome completo" required />
          </div>
          <div class="input-group">
            <label for="whatsapp">Seu WhatsApp (somente dígitos)</label>
            {{-- Adicionado name="whatsapp" --}}
            <input type="tel" id="whatsapp" name="whatsapp" placeholder="Ex: 11999998888" required />
          </div>
          <div class="input-group">
            <label for="aniversario">Aniversário (opcional, para brindes)</label>
            {{-- Adicionado name="aniversario" --}}
    ...
    {{-- Transformado em type="submit" para enviar o form --}}
